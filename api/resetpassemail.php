...
//echo "Config Loaded: " . json_encode($config); // Debug: Output config
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (!isset($_POST['email'])) {
    ...
    echo json_encode(array("error" => "Error: Email is required"));
    exit;
  }
  ...
  //echo "Database connected"; // Debug: Connection successful
  ...
  //echo "Statement prepared"; // Debug: Statement prepared
  ...
  //echo "Statement executed"; // Debug: Statement executed
  ...
  if ($result->num_rows > 0) {
    ...
    if ($ch != "1") {
      $emailbody1 = "Hello,<br><br>We got a request to reset your password.<br>Use the link below to get started.";
      $emailbody2 = "or copy and paste this link into your browser's address bar:";
      $emailbody3 = "If you did not request a password reset, you can safely ignore this email. Only a person with access to your email can reset your account password.";
      $emailbody4 = "Thank you,<br>Quanzhou Youth Business";
      $emailbody5 = "Chamber Team";
      $emailbodybtn = "https://quanzhouyouth.com/email/btn_eng.png";
    } else {
      $emailbody1 = "您好！<br><br>我们收到了您重置密码的要求";
      $emailbody2 = "或者将此链接复制并投放到浏览器的地址栏中：";
      $emailbody3 = "如果您没有发送重设密码的要求，您可以把电邮删除。 只有能登入此电邮的用户才可以重设密码。";
      $emailbody4 = "谢谢,<br>泉州青年商会委员会";
      $emailbody5 = "";
      $emailbodybtn = "https://quanzhouyouth.com/email/btn_ch.png";
    }
    ...
    try {
      ...
      if ($ch != "1") {
        $mail->Subject = 'Quanzhou Youth Business Chamber - Reset Your Password';
        $mail->setFrom('noreply@quanzhouyouth.com', 'quanzhouyouth');
      } else {
        $mail->Subject = '泉州青年商会 - 重置您的密码';
         ...
         <tr>
          <td align="center" style="padding:0;Margin:0">
           <table class="es-content-body" align="center" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;width:600px" role="none">
             ...
             <tr>
              <td align="left" style="Margin:0;padding-bottom:15px;padding-top:20px;padding-left:40px;padding-right:40px;background-color:#ffffff" bgcolor="#ffffff">
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:520px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
...
<!-- url -->
  <td align="left" style="padding:0;Margin:0;padding-left:40px;padding-right:40px;background-color:#ffffff" bgcolor="#ffffff">
    <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
      <tr>
        <td align="center" valign="top" style="padding:0;Margin:0;width:520px">
          <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
            <tr>
              <td align="left" class="es-m-txt-l" style="padding:0;Margin:0">
                <a href="$resetPasswordUrl" target="_blank" style="text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#3d50df;font-size:14px;padding:10px 30px 10px 5px;display:inline-block;background:#ffffff;border-radius:0px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:16.8px;width:auto;text-align:left">$resetPasswordUrl</a>
              </td>
            </tr>
          </table>
        </td>
...
<!-- url -->
             <tr>
              <td align="left" style="Margin:0;padding-bottom:15px;padding-top:20px;padding-left:40px;padding-right:40px;border-radius:0px 0px 20px 20px;background-color:#ffffff" bgcolor="#ffffff">
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:520px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
